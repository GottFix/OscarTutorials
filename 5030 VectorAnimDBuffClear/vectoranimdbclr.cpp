...
// Use a templated clear routine to get absolute addressing
template <int n>
void clrScreenBuffer(void)
{
	// Unroll to page writes
	#pragma unroll(page)
	for(int i=0; i<8000; i++)
		Hires[n][i] = 0;
}

// Fold template into parameter
void clrScreen(char n)
{
	switch(n)
	{
	case 0:
